...
public class Shop {
    ...
    public ItemStack[] getContents() {
        ...
        for (int a = 0; a < ilist.size(); a++) {
            ...
            if (c.c().size() == 0) {
                ...
                i[a] = CraftItemStack.asCraftMirror((net.minecraft.server.v1_8_R2.ItemStack.createStack(c)));
            }
        }
        return i;
    }
    ...
    public ItemStack getItem(final int index, final boolean withPriceText) {
        ...
        final net.minecraft.server.v1_8_R2.ItemStack item = net.minecraft.server.v1_8_R2.ItemStack.createStack(tag);
        if (withPriceText) {
            scs.addPrice(item);
    ...
    protected void loadData() {
        ...
        for (int i = 0; i < l.size(); i++)
        {
            storageinv.setItem(i, CraftItemStack.asCraftMirror(
                    net.minecraft.server.v1_8_R2.ItemStack.createStack(l.get(i))));
        }
    ...
    protected void setItem(final int index, final net.minecraft.server.v1_8_R2.ItemStack item, final boolean retainPrice) {
        final NBTTagList ilist = data.getList("items", 10);
        if (index >= ilist.size() || index < 0)
            throw new ArrayIndexOutOfBoundsException(index);
    ...
    protected void setItem(final NBTTagCompound old, final net.minecraft.server.v1_8_R2.ItemStack nms, final boolean retainPrice) {
    ...
    net.minecraft.server.v1_8_R2.ItemStack getRawItem(final int index) {
        final NBTTagList ilist = data.getList("items", 10);
        if (index >= ilist.size() || index < 0)
            return null;
        return net.minecraft.server.v1_8_R2.ItemStack.createStack(ilist.get(index));
    }
}
